...
class SimilarWindows(Resource):
    def get(self):
        ...
        @apiParam {Float} start Start timestamp.
        @apiParam {Float} end End timestamp.
        @apiParam {String} datarun_id Datarun ID.

        @apiSuccess {Object[]} windows A list of windows.
        @apiSuccess {Int} windows.start Window start timestamp.
        @apiSuccess {Int} windows.end Window end timestamp.
        """
