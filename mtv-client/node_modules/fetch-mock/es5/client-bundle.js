(function (global, factory) {
	...
	var generateMatcher = createCommonjsModule(function (module) {
	...
	var getParamsMatcher = function getParamsMatcher(_ref6) {
		...
		var keys = [];
		var re = pathToRegexp_1(matcher.replace(/^express:/, ''), keys);
		return function (url) {
	...
	unwrapExports(generateMatcher);

	var compileRoute = createCommonjsModule(function (module) {
	...
	unwrapExports(compileRoute);
	var compileRoute_1 = compileRoute.sanitizeRoute;
	...
	var sanitizeRoute = compileRoute.sanitizeRoute;
